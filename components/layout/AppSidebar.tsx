...
export function AppSidebar({ userRole }: AppSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 h-screen w-64 bg-slate-900 text-white transition-transform duration-300 ease-out lg:translate-x-0 ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold tracking-tight">TechSolutions</h1>
