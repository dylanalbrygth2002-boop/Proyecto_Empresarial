    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-900">
      ...
      <div className="relative z-10 w-full max-w-md px-6 animate-fade-in-scale">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl overflow-hidden hover-lift">
          ...
          <div className="px-8 py-4 bg-white/5 border-t border-white/10 animate-fade-in" style={{ animationDelay: '0.3s' }}>
        ...
        <p className="text-center text-slate-600 text-xs mt-8 animate-fade-in" style={{ animationDelay: '0.35s' }}>
